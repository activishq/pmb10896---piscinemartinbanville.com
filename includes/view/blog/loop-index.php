    ...
    while (have_posts()) : the_post();
        ...
        <article id="post-<?php echo the_ID(); ?>" <?php echo post_class('row-fluid blog-article standard-style normal'); ?>>                    
         ...
         ?>
				...
				<h1 class="toppic-title"><a href="<?php echo esc_url(get_permalink()) ?>"><?php echo esc_html(get_the_title()) ?></a></h1>
                <div class="media">
                ...
                <div class="content">
                    ...
                    <?php /* <h1><a href="<?php echo esc_url(get_permalink()) ?>"><?php echo esc_html(get_the_title()) ?></a></h1> */?>
                    <ul class="info">
                        <?php /*<li><i class="linecon-icon-user"></i><?php _e('Posted by', 'codeless') ?> <?php echo get_the_author() ?></li> */?>
                        <?php /*<li><i class="linecon-icon-calendar"></i><?php echo __('In effect until'); ?><?php _e('', 'codeless') ?> <?php echo get_the_date() ?></li> */?>                          
                        <?php /* <li><i class="icon-comment-o"></i><?php echo $count ?> <?php _e('financement auprès de La Banque Nationale', 'codeless') ?></li> */?> 
                        <?php if(!empty($tag_out) ): ?>
                                <li><i class="linecon-icon-tag"></i><?php echo $tag_out ?></li>
                        <?php endif; ?>     
                    ...
                    <?php if(!is_single()): ?>
                    <a href="<?php echo esc_url(get_permalink()) ?>" class="btn-bt <?php echo esc_attr($cl_redata['overall_button_style'][0]) ?>"><span><?php echo __('Find out more') ?></span><i class="moon-arrow-right-5"></i></a>
                    <?php endif; ?>
                    <?php if($cl_redata['post_like']): ?>  
