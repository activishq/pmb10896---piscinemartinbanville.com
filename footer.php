            ...
            <div id="copyright">
    	    	<div class="container">
    	        	<div class="row-fluid">
                        ...
                        <?php echo $cl_redata['copyright_text']; ?>

                        <?php 
                            if ( $polylang->curlang->slug == 'en' ) {
                                echo '<span class="footer-en">©2015 Piscine Martin Banville ─ All rights reserved.</span>';
                            } else {
                                echo '<span class="footer-fr">©2015 Piscine Martin Banville - Tous droits réservés.</span>';
                            }
                        ?>
